 ...
 */
UCLASS()
class PROJECTNOVA_API UShooterMovementComponent : public UPawnMovementComponent
{
	GENERATED_BODY()
...
public:
	...
	/** How much velocity is slowed by when running along a wall*/
	UPROPERTY(EditAnywhere, Category = "Control | General", meta = (ClampMin = "-1.0", ClampMax = "1.0"))
	float WallFrictionMultiplier;
