...
UCLASS()
class UNREALPLAYGROUND_API UStateMachine : public UObject
{
	GENERATED_BODY()
...
protected:
	...
	*/
	...
	/**
	* Set the initial state of the State Machine. Call this after you've Added the desired state
	* @param	State					The key of the state in this state machine's map
	*/
	...
	*/
	...
	void AddState(UObject* Context, const FString Key, const bool bIsActive = true)
	{
		...
		//TODO Determine if this is creating memory garbage
